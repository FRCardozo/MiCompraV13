...
export default function RegistroRepartidor() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Wallet: la dejas a cargo de triggers en BD.
      // Si hay algún console.error de wallet viejo, desaparecerá
      // al quitar cualquier inserción manual restante.
      ...
      navigate('/login', {
        ...
        state: {
          authMessage: {
            type: 'success',
            text:
              '¡Tu cuenta de repartidor se creó correctamente! Revisa tu correo si es necesario confirmarlo y luego inicia sesión para comenzar a recibir pedidos.',
          },
        },
      });
    } catch (err) {
      console.error('Error en registro de repartidor:', err);
