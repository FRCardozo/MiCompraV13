...
import { startLocationTracking, stopLocationTracking, requestLocationPermission } from '../../utils/gps';
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl p-6 mb-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className={`p-3 rounded-full ${locationTracking ? 'bg-green-100' : 'bg-gray-100'}`}>
                {locationTracking ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <h3 className="text-sm font-medium text-gray-600">Pedidos Disponibles</h3>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <h3 className="text-sm font-medium text-gray-600">Total Ganancias</h3>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <button className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow text-left">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Ver Pedidos Disponibles</h3>
            <p className="text-gray-600">Encuentra pedidos para entregar en tu zona</p>
          </button>

          <button className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow text-left">
            <Clock className="w-10 h-10 text-green-600 mb-4" />
            <h3 className="text-xl font-bold text-gray-900 mb-2">Mis Entregas Activas</h3>
            <p className="text-gray-600">Gestiona tus entregas en curso</p>
          </button>
        </div>
      </div>
    </div>
